...
use koharu_types::commands::{
    DeviceInfo, FileResult, IndexPayload, OpenDocumentsPayload, ThumbnailResult,
};
...
pub async fn get_thumbnail(
    ...
    let thumbnail = doc.image.thumbnail(200, 200);
...
pub async fn export_document(
    ...
    let bytes = encode_image(&document.image, &ext)?;
