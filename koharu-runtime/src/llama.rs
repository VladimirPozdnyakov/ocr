...
impl LlamaRuntime {
    ...
    fn detect() -> Result<Self> {
        ...
        // SAFETY: Loading nvcuda.dll is safe if NVIDIA drivers are installed.
        // We only check if the library can be loaded to detect CUDA availability,
        // not actually use the library handle.
